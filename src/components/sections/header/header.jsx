                ...
                <div className="container">
                    <nav className="navbar navbar-expand-lg">
                        <Link className="navbar-brand" to="/">
                            <img src="img/IICS/iics_image/main-logo-iics.png" alt="" className='w-[200px]' />
                        </Link>
                        ...
                        <div className="collapse navbar-collapse">
                            ...
                            <div className="others-option d-flex align-items-center">
                                ...
                                </div> */}
                                {
                                    pathName !== '/home-three' &&
                                    <div className="option-item">
                                        <Link to="/contact" className="default-btn"><span className='!text-[#000]'>Get Started</span> <i className="bx bx-chevron-right" /></Link>
                                    </div>
                                }
                            </div>
                        </div>
